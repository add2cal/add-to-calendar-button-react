...
The only relevant difference is that with the wrapper, you would use the `<AddToCalendarButton>` component instead of the `<add-to-calendar-button>` custom element.
